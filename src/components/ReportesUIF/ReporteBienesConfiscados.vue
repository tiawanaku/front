<template>
  <div class="row q-col-gutter-md justify-center">
    <div class="col-xs-12 text-bold text-primary text-h5">BIENES CONFISCADOS POR GESTIÓN </div>
    <div class="col-xs-12">
      <q-markup-table
        id="ReporteBCG"
        wrap-cells
...
export default {
  ...
  methods: {
    async generarReporte () {
      ...
      let url = 'denuncias/reporte/bienes-confiscados'
