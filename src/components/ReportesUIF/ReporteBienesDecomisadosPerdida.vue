<template>
  <div class="row q-col-gutter-md justify-center">
    <div class="col-xs-12 text-bold text-primary text-h5">BIENES DECOMISADOS POR PÉRDIDA DE DOMINIO, POR GESTIÓN</div>
    <div class="col-xs-12">
      <q-markup-table
        id="ReporteBDPDG"
        wrap-cells
        ...
        <thead>
          <tr>
            ...
            <th
              class="text-center bg-indigo-10 text-white"
              colspan="14"
            ><span class="text-h5">Desde: {{ fechaFiltro.fechaInicio || 'El inicio' }} - Hasta: {{ fechaFiltro.fechaFin ||  'Hoy'}}</span></th>
          </tr>
          <tr>
            <th
          ...
          <tr>
            ...
            <th class="text-center bg-blue-9 text-white">Cantidad</th>
            <th class="text-center bg-blue-9 text-white">Valor Económico Bs</th>
            <th class="text-center bg-blue-9 text-white">Descripcion</th>
          </tr>
        </thead>
        <tbody>
          <tr
